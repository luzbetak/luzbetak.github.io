...
function buildLocalReply(city, senderName) {
  return [
    ...
    '',
    'Yes, I am interested. I hold a Master’s degree in Computer Science, with a focus on Artificial Intelligence and Machine Learning. I bring 25+ years of experience as a Software Engineer and Data Engineer, with deep expertise in large-scale systems, data processing, and advanced programming. I’m based in Los Angeles, California. For roles in or near ' + (city || 'the listed city') + ', I can support on-site or remote as the client prefers.',
    '',
...
function buildElseReply(senderName) {
  return [
    greetLine(senderName),
    '',
    'Yes, I am interested. I hold a Master’s degree in Computer Science, with a focus on Artificial Intelligence and Machine Learning. I bring 25+ years of programming experience and am open to contract or contract-to-hire opportunities. I’m based in Los Angeles, California.  I’m open to fully remote work.', 
    '',
    'My compensation requirements are ' + COMP_REQUIRE_CONTRACT + ' or ' + COMP_REQUIRE_FULLTIME + '.',
